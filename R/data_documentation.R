...
#' Gas Purchases Data (s9)
#'
#' This dataset contains annual land available for permitting, in billion cubic meters.
#' The data was extracted from the 'ST98-NaturalGas-SupplyDemand-data.xlsx' Excel file.
...
#' Gas Purchases Data (s10)
#'
#' This dataset contains number of horizontal and vertical wells as well as production in million cubic meters per day.
#' The data was extracted from the 'ST98-NaturalGas-SupplyDemand-data.xlsx' Excel file.
#' @format A data frame with 33 rows and 5 columns.
#' @source Original data was sourced from [https://www.aer.ca/providing-information/data-and-reports/statistical-reports/st98/statistics-and-data].
#' @name s10
NULL
